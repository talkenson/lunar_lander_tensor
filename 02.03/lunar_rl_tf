...
with tf.Session() as sess:
    sess.run(init)
    saver.restore(sess, "/home/vitaly/PycharmProjects/rl_ll/venv/weights/model.ckpt")
    ...
    while i < total_episodes:
        ...
        if i % 1000 == 0:
            save_path = saver.save(sess, "/home/vitaly/PycharmProjects/rl_ll/venv/weights/model.ckpt")
